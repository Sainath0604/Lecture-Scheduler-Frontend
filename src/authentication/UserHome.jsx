  ...
  return (
    <div className="dark:bg-white	bg-[#121212] min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center p-2 ">
        <div className="bg-gray-50 border w-full md:w-2/3 border-gray-700 rounded-xl space-y-4 lg:space-y-8 mt-8 mx-5  lg:m-10 p-4 lg:p-10 text-base ">
          <div className="border-t border-b border-r border-gray-900 rounded-lg">
            <div className="flex">
              ...
              <div className="pl-5 py-2 ">
                <span className="text-black dark:text-emerald-600">
                  {userData.fName}
                </span>
              </div>
            </div>
